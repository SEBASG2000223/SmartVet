        ...
        <div class="row">
            <div class="col-md-12" id="formulario_update" style="display: none;">
                <div class="card card-dark">
                    ...
                    <div class="card-body">
                        <form id="customer_update" method="POST">
                            <input type="hidden" id="EId" name="id">
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    <label for="Eemail_address">Correo Electrónico</label>
                                    <input type="email" class="form-control" id="Eemail_address" name="email_address" required readonly>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="Efull_name">Nombre Completo</label>
                                    <input type="text" class="form-control" id="Efull_name" name="full_name" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
