...
<head>
    ...
    <title>Administración de Detalles de Factura</title>
    ...
    <div class="container mt-4">
            ...
            <div class="col-md-12" id="formulario_add">
                <div class="card card-dark">
                    <div class="card-header">
                        <h3 class="card-title">Agregar Detalle de Factura</h3>
                    </div>
                    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-12" id="formulario_update" style="display: none;">
                <div class="card card-dark">
                    <div class="card-header">
                        <h3 class="card-title">Modificar Detalle de Factura</h3>
                    </div>
                    <div class="card-body">
                        <form id="detalle_update" method="POST">
                            <input type="hidden" id="EIdDetalles" name="id_detalles_facturas">
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    <label for="EIdFactura">ID Factura</label>
                                    <input type="text" class="form-control" id="EIdFactura" name="id_factura" required readonly>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="EIdEstado">ID Estado</label>
                                    <input type="text" class="form-control" id="EIdEstado" name="id_estado" required>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="ETotal">Total</label>
                                    <input type="number" class="form-control" id="ETotal" name="total" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-dark">
                    <div class="card-header">
                        <h3 class="card-title">Detalles de Facturas Existentes</h3>
                    </div>
...
<script src="assets/js/detalleFactura.js"></script>
</body>
</html>
