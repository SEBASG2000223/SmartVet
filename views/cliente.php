    ...
    <div class="container mt-4">
        <div class="row">
            <div class="col-md-12" id="formulario_add">
                <div class="card card-dark">
                    ...
                    <div class="card-body">
                        <form id="cliente_add" method="POST">
                            <div class="form-row">
        ...
        <div class="row">
            <div class="col-md-12" id="formulario_update" style="display: none;">
                <div class="card card-dark">
                    <div class="card-header">
                        <h3 class="card-title">Modificar un Cliente</h3>
                    </div>
                    <div class="card-body">
                        <form id="cliente_update" method="POST">
                            <input type="hidden" id="EId" name="id_cliente">
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    <label for="Enombre_cliente">Nombre del Cliente</label>
                                    <input type="text" class="form-control" id="Enombre_cliente" name="nombre_cliente" required>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="Eapellido_cliente">Apellido del Cliente</label>
                                    <input type="text" class="form-control" id="Eapellido_cliente" name="apellido_cliente" required>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="Etelefono">Teléfono</label>
                                    <input type="number" class="form-control" id="Etelefono" name="telefono" required>
                                </div>
                                <div class="form-group col-md-4">
